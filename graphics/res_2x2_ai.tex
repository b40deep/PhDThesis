...
% the page so there is some space between the images.
	\subfloat[Top-Left image sub-caption.]{
		\includegraphics[width=0.485\textwidth]{graphics/c_doc1.png}\label{fig:example_2x2_a}
	}\hfill % Spacing between sub-figures displayed next to each other.
	\subfloat[Top-Right image sub-caption.]{
		\includegraphics[width=0.485\textwidth]{graphics/i_doc1.png}\label{fig:example_2x2_b}
	}\\ % New line before caption.
	\subfloat[Bottom-Left image sub-caption.]{
		\includegraphics[width=0.485\textwidth]{graphics/i_tshirtgfx.png}\label{fig:example_2x2_c}
	}\hfill % Spacing between sub-figures displayed next to each other.
	\subfloat[Bottom-Right image sub-caption.]{
		\includegraphics[width=0.485\textwidth]{graphics/i_zumba.png}\label{fig:example_2x2_d}
	}\\ % New line before caption.
